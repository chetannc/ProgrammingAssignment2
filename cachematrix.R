## makeCacheMatrix and cacheSolve are two functions used to create and retrive
## inverse of a matrix when present in cache rather than compute it repeatedly 
